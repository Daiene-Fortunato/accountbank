...
[Diagrama de Relacionamento MySQL](https://github.com/Daiene-Fortunato/itexperts/diagramabanco.png)
...
- [x] Necessário utilizar SPRING BOOT, o acesso e documentação devem ser feitos via SWAGGER;
  ...
  [Imagem run da api](https://github.com/Daiene-Fortunato/itexperts/images/codigoapi.png)

  [Imagem home no swagger](https://github.com/Daiene-Fortunato/itexperts/images/swaggerhome.png)

  [Imagem do banco de dados](https://github.com/Daiene-Fortunato/itexperts/images/accountdata.png)

- [x] Implementar CREATE, READ e DELETE;

  [Imagem codigo CRUD](https://github.com/Daiene-Fortunato/itexperts/images/codigocrud.png)

  [Imagem create no swagger](https://github.com/Daiene-Fortunato/itexperts/images/swaggercrud.png)
...
- [x] A API deve listar todas as contas e os cartões relacionados à elas;
  ...
  [Imagem list all contas](https://github.com/Daiene-Fortunato/itexperts/images/listallcontas.png)

- [x] As contas devem ser criadas junto com seus respectivos cartões;

  [Imagem Create Conta](https://github.com/Daiene-Fortunato/itexperts/images/createconta.png)
...
- [x] Para o DELETE, não é possível deletar a conta bancária se houver algum cartão vinculado à ela; Primeiro deletar cartões, depois conta;
  ...
  [Imagem Delete Conta](https://github.com/Daiene-Fortunato/itexperts/images/deleteconta.png)

- [x] Fornecer o Script de criação do banco de dados;

  [Imagem Script Create](https://github.com/Daiene-Fortunato/itexperts/images/scriptcreate.png)

  [Imagem Script Insert](https://github.com/Daiene-Fortunato/itexperts/images/scriptinsert.png)

- [x] Usar Maven ou Gradle para gerenciar as dependências;

  [Imagem Maven](https://github.com/Daiene-Fortunato/itexperts/images/maven.png)

- [x] Usar Git, comitar cada processo e disponibilizar o projeto em um repositório público.

  [Imagem Git Commits](https://github.com/Daiene-Fortunato/itexperts/images/gitcommit.png)

Nível Avançado:

- [x] Documentar via Swagger;

  [Imagem Swagger.Config](https://github.com/Daiene-Fortunato/itexperts/images/swaggerconfig.png)

- [x] Criar UPDATE apenas para a mudança dos tipos de cartões vinculados às contas;

  [Imagem Update Type](https://github.com/Daiene-Fortunato/itexperts/images/updatetype.png)
...
- [x] Implementar o projeto na nuvem utilizando AWS através do AWS Code Pipeline (CI/CD) e fornecer a Url.
  ...
  [Imagem Instancia T2 EC2](https://github.com/Daiene-Fortunato/itexperts/images/instanciat2ec2.png) 

  [Imagem Instancia RDS T2](https://github.com/Daiene-Fortunato/itexperts/images/instanciardst2.png)

- [x] Executar o projeto localmente.

  [Imagem API URL local](https://github.com/Daiene-Fortunato/itexperts/images/localhost.png)
